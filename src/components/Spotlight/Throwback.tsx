  ...
  return (
    <div className="absolute bottom-1 right-1 h-[215px] w-[185px] overflow-hidden rounded-lg border border-gray-400 bg-[#f4f4f4] shadow-[4px_5px_0_rgba(0,0,0,0.12)] sm:h-[220px] sm:w-[190px]">
      ...
      {image ? (
        ...
        <div className="mx-2.5 mt-1 flex h-[165px] items-center justify-center rounded-lg border-2 border-dashed border-[#a1a1b0] text-center font-mono text-xs leading-5 text-[#76768a]">
          THROWBACK
          <br />
          PHOTO
          <br />
